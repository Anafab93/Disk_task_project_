...
Cfg.red = [(207 * Cfg.red_weight) 0 0];
Cfg.green = [0 (121 * Cfg.green_weight) 0];
...
for tr = 1 : nTrials
    ...
    usePoint = randi(2,1); %Esto lo modificamos, somos chidos, pero más Pablo, yo le sé a lavar tazas :'(.
    ...
    mondrians = randperm(10);
    TR(tr).gender_mask = mondrians(1);
